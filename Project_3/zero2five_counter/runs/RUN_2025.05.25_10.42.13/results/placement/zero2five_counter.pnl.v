module zero2five_counter (an,
 ...
 sky130_fd_sc_hd__inv_2 _41_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_07_));
 sky130_fd_sc_hd__dfrtp_4 _42_ (.CLK(clk),
    .D(_00_),
    .RESET_B(_04_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net2));
 sky130_fd_sc_hd__dfrtp_4 _43_ (.CLK(clk),
    .D(_01_),
    .RESET_B(_05_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net3));
 sky130_fd_sc_hd__dfrtp_4 _44_ (.CLK(clk),
    .D(_02_),
    .RESET_B(_06_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net4));
 sky130_fd_sc_hd__dfrtp_4 _45_ (.CLK(clk),
    .D(_03_),
    .RESET_B(_07_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_1 output12 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(seg[6]));
 sky130_fd_sc_hd__conb_1 zero2five_counter_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net13));
